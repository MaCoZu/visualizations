...
graph1 = (
    dbc.Card(
        [html.Div(id="error_msg1", className="text-danger"), dcc.Graph(id="graph-id1", config= {'displaylogo': False})]
    ),
)
...
graph2 = dbc.Card(
    [html.Div(id="error_msg2", className="text-danger"), dcc.Graph(id="graph-id2", config= {'displaylogo': False})],
)
...
graph3 = dbc.Card(
    [html.Div(id="error_msg3", className="text-danger"), dcc.Graph(id="graph-id3", config= {'displaylogo': False})],
)
...
graph4 = dbc.Card(
    [html.Div(id="error_msg4", className="text-danger"), dcc.Graph(id="graph-id4", config= {'displaylogo': False})],
)
...
logo_base64 = base64.b64encode(open("./img/logo.png", "rb").read()).decode("ascii")


navbar = dbc.Nav(
    [
        dbc.NavItem(
            html.Img(src="data:image/png;base64,{}".format(logo_base64), height="50px"),
            class_name="text-start mx-2",
        ),
        dbc.NavItem(
            html.H2("World Bank Commander"), class_name="text-center pt-2 mx-2"
        ),
...
@callback(
    ...
    [Input("country-id1", "value"), Input("indicator-id1", "value")],
)
def make_graph1(country_list, indicator_code):
...
def make_graph2(country_list, indicator_code):
    if country_list is None or len(country_list) == 0 or indicator_code is None:
        return {}
    else:
        return utils.plot(country_list, indicator_code)
...
@callback(
    ...
    [Input("country-id3", "value"), Input("indicator-id3", "value")],
)
def make_graph2(country_list, indicator_code):
    if country_list is None or len(country_list) == 0 or indicator_code is None:
        return {}
...
@callback(
    ...
    [Input("country-id4", "value"), Input("indicator-id4", "value")],
)
def make_graph2(country_list, indicator_code):
    if country_list is None or len(country_list) == 0 or indicator_code is None:
        return {}
